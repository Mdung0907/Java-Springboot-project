...
<script type="text/javascript">
	function Validatedata() {
		...
		if (email == '') {
			document.getElementById("erremail").innerHTML = "Email cannot be left blank"
			return false;
		} else {
			return true;
		}
				...
				<div class="well">
					<form class="form-horizontal" name="frmRegister"
						...
						<div class="control-group">
							<label class="control-label">Email<sup>*</sup></label> <input
								name="email" /> <br> <span id="erremail"
								style="color: red">${messageEmail}</span>
						</div>
