...
<script type="text/javascript">
	function Validatedata() {
		var code = document.frmRegister.code.value;
		if (code == '') {
			document.getElementById("errcode").innerHTML = "Code cannot be left blank"
			return false;
		} else {
			return true;
		}
			...
			<div class="span9">
				...
				<div class="well">
					<form class="form-horizontal" name="frmRegister"
						action="/forgotPasswordContinue" method="post"
						onsubmit="return Validatedata()">
						<h3>Confirm Code</h3>
						<div class="control-group">
							<label class="control-label">Code<sup>*</sup></label> <input
								name="code" /> <br> <span id="errcode" style="color: red">${messagecode}</span>
						</div>
